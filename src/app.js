...
const ANIMATION_OPTIONS = [
  { id: "greeting", label: "Greeting", url: "./animations/vrma_02.vrma" },
  ...
  { id: "peace", label: "Peace", url: "./animations/vrma_03.vrma" },
  { id: "shoot", label: "Shoot", url: "./animations/vrma_04.vrma" },
  { id: "spin", label: "Spin", url: "./animations/vrma_05.vrma" },
  { id: "pose", label: "Pose", url: "./animations/vrma_06.vrma" },
  { id: "squat", label: "Squat", url: "./animations/vrma_07.vrma" },
